...
const Intro = () => {
  return (
    <div className='mt-20 px-48 text-white text-left'>
      ...
      <div className='flex justify-between'>
        ...
        <div>
          <div style={{ width: '490px' }} className='rounded-lg border-2 text-left p-7'>
            ...
            <Button style={{ backgroundColor: '#395f9e' }} className='border-2 rounded p-2 font-semibold border-black cursor-pointer relative mt-5'>
              <span>Resume</span>
            </Button>
          </div>
        </div>
